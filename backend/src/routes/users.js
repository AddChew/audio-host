...
router.get('/:userid', checkAuthenticated, controller.getUser) // GET /users/:userid
router.put('/:userid', checkAuthenticated, controller.updateUser) // PUT /users/:userid
router.delete('/:userid', checkAuthenticated, controller.deleteUser) // DELETE /users/:userid
